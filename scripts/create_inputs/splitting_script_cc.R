...
#setwd("/home/fs02/pmr82_0001/rg727/CALFEWS/climate_change_sets/4T_1CC/baseline_datasets")
...
data=read.table(paste0("/home/fs02/pmr82_0001/rg727/WGEN/Final/ORO/streamflow/",T,"T_",CC,"CC/snow_",T,"T_",CC,"CC_full.txt"),header=TRUE)
...
data=read.table(paste0("/home/fs02/pmr82_0001/rg727/WGEN/Final/SHA/streamflow/",T,"T_",CC,"CC/snow_",T,"T_",CC,"CC_full.txt"),header=TRUE)
all_datasets$SHA_snow=data[,j]

data=read.table(paste0("/home/fs02/pmr82_0001/rg727/WGEN/Final/FOL/streamflow/",T,"T_",CC,"CC/snow_",T,"T_",CC,"CC_full.txt"),header=TRUE)
all_datasets$FOL_snow=data[,j]

data=read.table(paste0("/home/fs02/pmr82_0001/rg727/WGEN/Final/YRS/streamflow/",T,"T_",CC,"CC/snow_",T,"T_",CC,"CC_full.txt"),header=TRUE)
all_datasets$YRS_snow=data[,j]

data=read.table(paste0("/home/fs02/pmr82_0001/rg727/WGEN/Final/YRS/streamflow/",T,"T_",CC,"CC/snow_",T,"T_",CC,"CC_full.txt"),header=TRUE)
all_datasets$NML_snow=data[,j]

data=read.table(paste0("/home/fs02/pmr82_0001/rg727/WGEN/Final/TLG/streamflow_test/",T,"T_",CC,"CC/snow_",T,"T_",CC,"CC_full.txt"),header=TRUE)
all_datasets$DNP_snow=data[,j]

data=read.table(paste0("/home/fs02/pmr82_0001/rg727/WGEN/Final/MRC/streamflow/",T,"T_",CC,"CC/snow_",T,"T_",CC,"CC_full.txt"),header=TRUE)
all_datasets$EXC_snow=data[,j]

data=read.table(paste0("/home/fs02/pmr82_0001/rg727/WGEN/Final/MIL/streamflow_test/",T,"T_",CC,"CC/snow_",T,"T_",CC,"CC_full.txt"),header=TRUE)
all_datasets$MIL_snow=data[,j]

data=read.table(paste0("/home/fs02/pmr82_0001/rg727/WGEN/Final/PNF/streamflow/",T,"T_",CC,"CC/snow_",T,"T_",CC,"CC_full.txt"),header=TRUE)
all_datasets$PNF_snow=data[,j]

data=read.table(paste0("/home/fs02/pmr82_0001/rg727/WGEN/Final/TRM/streamflow/",T,"T_",CC,"CC/snow_",T,"T_",CC,"CC_full.txt"),header=TRUE)
all_datasets$KWH_snow=data[,j]

data=read.table(paste0("/home/fs02/pmr82_0001/rg727/WGEN/Final/SCC/streamflow/",T,"T_",CC,"CC/snow_",T,"T_",CC,"CC_full.txt"),header=TRUE)
all_datasets$SUC_snow=data[,j]

data=read.table(paste0("/home/fs02/pmr82_0001/rg727/WGEN/Final/ISB/streamflow/",T,"T_",CC,"CC/snow_",T,"T_",CC,"CC_full.txt"),header=TRUE)
all_datasets$ISB_snow=data[,j]

all_datasets[,3:14]=all_datasets[,3:14]*0.0393701 #change to inches 

data=read.table(paste0("/home/fs02/pmr82_0001/rg727/WGEN/Final/ORO/streamflow/",T,"T_",CC,"CC/streamflow_",T,"T_",CC,"CC_full_snow_test.txt"),header=TRUE)
all_datasets$ORO_fnf=data[,j]

data=read.table(paste0("/home/fs02/pmr82_0001/rg727/WGEN/Final/SHA/streamflow/",T,"T_",CC,"CC/streamflow_",T,"T_",CC,"CC_full_snow_test.txt"),header=TRUE)
all_datasets$SHA_fnf=data[,j]

data=read.table(paste0("/home/fs02/pmr82_0001/rg727/WGEN/Final/FOL/streamflow/",T,"T_",CC,"CC/streamflow_",T,"T_",CC,"CC_full_snow_test.txt"),header=TRUE)
all_datasets$FOL_fnf=data[,j]

data=read.table(paste0("/home/fs02/pmr82_0001/rg727/WGEN/Final/YRS/streamflow/",T,"T_",CC,"CC/streamflow_",T,"T_",CC,"CC_full_snow_test.txt"),header=TRUE)
all_datasets$YRS_fnf=data[,j]

data=read.table(paste0("/home/fs02/pmr82_0001/rg727/WGEN/Final/NML/streamflow/",T,"T_",CC,"CC/streamflow_",T,"T_",CC,"CC_full_snow_test.txt"),header=TRUE)
all_datasets$NML_fnf=data[,j]

data=read.table(paste0("/home/fs02/pmr82_0001/rg727/WGEN/Final/TLG/streamflow_test/",T,"T_",CC,"CC/streamflow_",T,"T_",CC,"CC_full_snow_test.txt"),header=TRUE)
all_datasets$DNP_fnf=data[,j]

data=read.table(paste0("/home/fs02/pmr82_0001/rg727/WGEN/Final/MRC/streamflow/",T,"T_",CC,"CC/streamflow_",T,"T_",CC,"CC_full_snow_test.txt"),header=TRUE)
all_datasets$EXC_fnf=data[,j]

data=read.table(paste0("/home/fs02/pmr82_0001/rg727/WGEN/Final/MIL/streamflow_test/",T,"T_",CC,"CC/streamflow_",T,"T_",CC,"CC_full_snow_test.txt"),header=TRUE)
all_datasets$MIL_fnf=data[,j]

data=read.table(paste0("/home/fs02/pmr82_0001/rg727/WGEN/Final/PNF/streamflow/",T,"T_",CC,"CC/streamflow_",T,"T_",CC,"CC_full_snow_test.txt"),header=TRUE)
all_datasets$PFT_fnf=data[,j]

data=read.table(paste0("/home/fs02/pmr82_0001/rg727/WGEN/Final/TRM/streamflow/",T,"T_",CC,"CC/streamflow_",T,"T_",CC,"CC_full_snow_test.txt"),header=TRUE)
all_datasets$KWH_fnf=data[,j]

data=read.table(paste0("/home/fs02/pmr82_0001/rg727/WGEN/Final/SCC/streamflow/",T,"T_",CC,"CC/streamflow_",T,"T_",CC,"CC_full_snow_test.txt"),header=TRUE)
all_datasets$SUC_fnf=data[,j]

data=read.table(paste0("/home/fs02/pmr82_0001/rg727/WGEN/Final/ISB/streamflow/",T,"T_",CC,"CC/streamflow_",T,"T_",CC,"CC_full_snow_test.txt"),header=TRUE)
...
#write.csv(batch_5,paste0("/home/fs02/pmr82_0001/rg727/CALFEWS/climate_change_sets/",T,"T_",CC,"CC/",ensemble_member,"/5/5.csv"),row.names = FALSE)

batch_6=all_datasets[55121:66078,3:ncol(all_datasets)]
write.csv(batch_6,paste0("/home/fs02/pmr82_0001/rg727/CALFEWS/climate_change_sets/",T,"T_",CC,"CC/",ensemble_member,"/6/6.csv"),row.names = FALSE)

#batch_7=all_datasets[66079:77035,3:ncol(all_datasets)]
#write.csv(batch_7,paste0("/home/fs02/pmr82_0001/rg727/CALFEWS/climate_change_sets/",T,"T_",CC,"CC/",ensemble_member,"/7/7.csv"),row.names = FALSE)

#batch_8=all_datasets[77036:87993,3:ncol(all_datasets)]
#write.csv(batch_8,paste0("/home/fs02/pmr82_0001/rg727/CALFEWS/climate_change_sets/",T,"T_",CC,"CC/",ensemble_member,"/8/8.csv"),row.names = FALSE)

#batch_9=all_datasets[87994:98950,3:ncol(all_datasets)]
#write.csv(batch_9,paste0("/home/fs02/pmr82_0001/rg727/CALFEWS/climate_change_sets/",T,"T_",CC,"CC/",ensemble_member,"/9/9.csv"),row.names = FALSE)
