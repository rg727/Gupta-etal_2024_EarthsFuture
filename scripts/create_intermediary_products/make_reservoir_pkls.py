...
output_folder = "/home/fs02/pmr82_0001/rg727/Figure6/4T_1CC/"
...
test_monthly=test
test=test_monthly['shasta_Q'].values
...
for i in range(2,50):
    ...
    if my_file.exists():
      ...
      datDaily['Date']=datDaily.index
      #datDaily=datDaily[datDaily["Date"].dt.month.isin([9])]
      test=datDaily['shasta_R_to_delta']
...
for i in range(2,50):
    ...
    if my_file.exists():
      ...
      test=test_monthly['shasta_R_to_delta'].values
...
data.to_pickle('shasta_Q_1550_1580.pkl')    
